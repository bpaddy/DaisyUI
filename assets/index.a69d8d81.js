const l=function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const a of t.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function s(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerpolicy&&(t.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?t.credentials="include":e.crossorigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function i(e){if(e.ep)return;e.ep=!0;const t=s(e);fetch(e.href,t)}};l();document.querySelector("header").classList.add("sticky","top-0","z-50");document.querySelector("header").innerHTML=`
      ...
      <ul class="menu menu-horizontal p-0">
        ...
        <li tabindex="0">
          ...
          <ul class="p-2 bg-base-100">
            <li href="#services"><a>Web Design</a></li>
            <li href="#services"><a>SEO</a></li>
            <li href="#services"><a>Accessibility</a></li>
          </ul>
        </li>
...
<div class="footer footer-center p-10 bg-base-200 text-base-content rounded">
  ...
  <div>
    <p>Copyright \xA9 2022 - All right reserved by ACME Industries Ltd</p>
  </div>
</div>
`;document.querySelector("main").classList.add("grid","max-w-screen-xl","mx-auto","bg-gray-50");document.querySelector("main").innerHTML+=`
...
<div id="services" class="min-h-screen bg-gray-50 py-8 flex flex-col justify-center relative overflow-hidden lg:py-12">
